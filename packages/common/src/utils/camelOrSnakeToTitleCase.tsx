...
export default function camelOrSnakeToTitleCase(
  ...
  if (Array.isArray(str)) {
    return str.map((s) => camelOrSnakeToTitleCase(s, underscoreReplacement, hyphenReplacement) as string);
  }
  ...
  str = str.replace(/-/g, underscoreReplacement.trim() === "-" ? "-" : hyphenReplacement); // Replace each hyphen with a space
