...
import { ChevronLeft as ArrowBackIosNewOutlinedIcon, ChevronUp as KeyboardArrowUpOutlinedIcon, ChevronsUpDown as UnfoldMoreOutlinedIcon } from "lucide-react";
        ...
        >
          {expandSideButton !== false && ((!isOverflowingLeft && isOverflowingRight) || (!isOverflowingLeft && showExpandSideButton)) && (
            <div className="px-0">
              <Button
                ...
                onClick={(e: any) => handleDialogOpen()}
              >
                <UnfoldMoreOutlinedIcon size={20} />
              </Button>
            </div>
          )}
          <div
          ...
          >
            {showButtons && isOverflowingLeft && (
              ...
              >
                <ArrowBackIosNewOutlinedIcon size={16} />
              </Button>
            )}
          </div>
