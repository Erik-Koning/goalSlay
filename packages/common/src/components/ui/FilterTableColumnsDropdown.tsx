...
import { ArrowUpDown as HeightOutlinedIcon, Filter as FilterAltOutlinedIcon } from "lucide-react";
    ...
    return (
      <div ref={dropdownDiv} className={cn(className)}>
        {isDragging && open && (
          ...
          >
            <HeightOutlinedIcon size={20} className="-left-4 -top-3" />
          </div>
        )}
        <DropdownMenu
          open={open}
