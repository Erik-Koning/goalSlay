...
import { EyeOff as VisibilityOffOutlinedIcon, Eye as VisibilityOutlinedIcon } from "lucide-react";
    ...
    <div>
      ...
      >
        <div className="flex h-fit items-center justify-center gap-x-2">
          {!hideIcon && (isHidden ? <VisibilityOffOutlinedIcon size={iconSize} /> : <VisibilityOutlinedIcon size={iconSize} />)}
          {isHidden ? (
