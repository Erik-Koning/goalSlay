...
import { 
  ...
  LayoutDashboard as DashboardCustomizeOutlined,
  Activity as AutoGraphRounded,
  Users as ConnectWithoutContactRounded,
  Layout as LineStyleRounded,
  CheckSquare as TaskRounded,
  Users as ConnectWithoutContactOutlined,
  LayoutDashboard as DashboardCustomizeRounded,
  Layout as LineStyleOutlined,
  CheckSquare as TaskOutlined,
  Activity as AutoGraphOutlined,
  HelpCircle as HelpOutlineOutlined,
  Settings as SettingsOutlined,
  User as RecentActorsOutlined,
  LogOut as LogoutOutlined,
  Inbox as InboxOutlined,
  Mail as OutboxOutlined,
  Inbox as MoveToInboxOutlined,
  ChevronLeft as ArrowBackIosNewOutlinedIcon,
  User as PermIdentityOutlinedIcon,
  Building2 as CorporateFareOutlinedIcon,
  Inbox as InboxIcon
} from "lucide-react";
            ...
            <ul className={ulClass}>
              <Link className={liClass} href="/entries">
                <TooltipWrapper
                  ...
                  disabled={expanded}
                >
                  <DashboardCustomizeOutlined size={iconSize} />
              ...
              <Link className={liClass} href="/inbound">
                <TooltipWrapper
                  ...
                  disabled={expanded}
                >
                  <MoveToInboxOutlined size={iconSize} />
              ...
              {/*<li className={liClass} onClick={() => navigateToPath(router,"/referring-dentists")}>
                <TooltipWrapper
                  ...
                  disabled={expanded}
                >
                  <RecentActorsOutlined size={iconSize} />
              ...
              {isTestDevOrSuperAppAdmin(userObj?.email) && (
                <Link className={liClass} href="/templates">
                  <TooltipWrapper
                    ...
                    disabled={expanded}
                  >
                    <LineStyleOutlined size={iconSize} />
            ...
            sideOffset={10}
					...
					></TooltipWrapper>
								<div className={menuItemsOutlineClass}>
									<AutoGraphOutlined size={iconSize} />
									{expanded && (
            ...
            <ul className={cn(ulClass, "pb-0.5")}>
              ...
              <Link className={liClass} href="/settings">
                <TooltipWrapper
                  ...
                  disabled={expanded}
                >
                  <SettingsOutlined size={iconSize} />
              ...
              <li className={liClass} onClick={() => {}}>
                <TooltipWrapper
                  ...
                  disabled={expanded}
                >
                  <LogoutOutlined size={iconSize} style={{ transform: "rotate(180deg)" }} />
                    ...
                    <div className="flex w-full items-center justify-center">
                      <div className="grid" style={{ display: "grid", gridTemplateColumns: "auto 1fr", gridTemplateRows: "auto auto", gap: "5px" }}>
                        <div className="flex items-center gap-x-1">
                          <PermIdentityOutlinedIcon size={iconSize} />
                        ...
                        <div className="flex items-center gap-x-1 pt-1" style={{ gridColumn: "1 / 2" }}>
                          <CorporateFareOutlinedIcon size={iconSize} />
          ...
          >
            ...
            >
              <div className="mx-auto flex h-full cursor-pointer items-center justify-center" hidden={expandButtonInMenu && hideDrawerExpandButton}>
                ...
                >
                  <ArrowBackIosNewOutlinedIcon size={20} className="-m-[2px]" />
                </div>
              </div>
            </div>
          </TooltipWrapper>
