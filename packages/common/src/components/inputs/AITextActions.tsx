...
export const AITEXT_VALUES = ["Expand", "Proofread", "Improve Tone", "Shorten", "Formatted List", "Numbered List", "Custom Prompt"] as const; // Use `as const` for a readonly tuple

export type AITextString = (typeof AITEXT_VALUES)[number];
export interface AITextItem {
  text: AITextString;
  shortText?: string;
  icon: React.ElementType; // Type for icons
  prompt: string;
...
export const AITextActionItems: AITextItem[] = [
  ...
  },*/
  {
    text: "Numbered List",
    icon: ListOrdered,
    prompt: "Convert the text into a formatted and numbered list",
    iconClassName: "text-blue-600",
    containerClassName: "bg-blue-100 border-blue-500",
  },
  {
